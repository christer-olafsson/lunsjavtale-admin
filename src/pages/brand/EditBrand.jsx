...
const EditBrand = ({ data, fetchBrands, closeDialog }) => {
  ...
  return (
    <Box sx={{
      ...
      <Stack flex={1} gap={2}>
        ...
        <TextField onChange={handleInputChange} placeholder='https://example.com' value={payload.siteUrl} name='siteUrl' label='Website URL' />
